...
const views = {
  ...
  projects: `
    <div class="project-container" style="background:none; border-color: none;">
        ...
        <p style="border-bottom: 0.5em; border-style: solid; border-color: #f6f6f6; margin-left: 3em; margin-bottom: -1.2em; cursor:pointer;"><a a href="./ornament/trying0.html">/ Encrypted Prayers</a></p>
